...
-- This explicitly orders items by processing status (processing, then pending, then others)
-- and then by id ASC, which perfectly matches the FIFO popping order of the queue processor.
