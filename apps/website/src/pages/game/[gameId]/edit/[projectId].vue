        ...
        <div class="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-5 h-fit shadow-xl">
          ...
          <div class="space-y-1">
            ...
            <input
              ...
              required
              placeholder="fr-FR"
              class="w-full px-4 py-2.5 bg-slate-950 border border-slate-800 rounded-xl text-white placeholder-slate-600 focus:outline-none focus:ring-2 focus:ring-cyan-500 text-sm"
            />
          </div>
