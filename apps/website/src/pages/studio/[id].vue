  ...
  <DetailsPage v-if="studio">
    ...
    >
      <template #metadata v-if="studio.city || studio.country">
        <span
          class="text-gray-900 dark:text-gray-100 font-semibold text-base md:text-lg bg-white/60 dark:bg-black/50 backdrop-blur-md px-3 py-1 rounded-lg flex items-center gap-2"
        >
          <svg
    ...
    <div class="w-full p-4 md:p-8 max-w-6xl mx-auto">
      ...
      <section class="mb-12" v-if="dubbedProjects.length > 0">
        ...
        >
          ...
          >
            <div
              class="relative w-full aspect-[2/3] rounded-xl overflow-hidden mb-3 bg-gray-200 dark:bg-gray-800 shadow-sm border border-gray-200 dark:border-[#2a2a2a] group-hover:border-cyan-500 transition-colors"
            >
              <NuxtImg
            ...
            <h3
              class="font-semibold text-sm md:text-base text-gray-900 dark:text-gray-100 line-clamp-2"
            >
              {{
                project.media?.title ||
                project.media?.name ||
            ...
            <div
              class="text-xs text-gray-500 dark:text-gray-400 mt-1 uppercase font-bold tracking-wider"
            >
      ...
      <section v-if="voiceActorsRoster.length > 0">
        ...
        >
          ...
          >
            <div
              class="bg-white dark:bg-[#1d1d1d] border border-gray-200 dark:border-[#2a2a2a] rounded-xl overflow-hidden hover:border-cyan-500 transition-colors flex flex-col items-center p-4 text-center"
            >
              <div
                class="w-20 h-20 rounded-full overflow-hidden mb-3 bg-gray-200 dark:bg-[#2a2a2a] shrink-0 border-2 border-transparent group-hover:border-cyan-500 transition-colors"
              >
                <img
                ...
                <div
                  v-else
                  class="w-full h-full flex items-center justify-center font-bold text-xl text-gray-400"
                >
              ...
              <h3
                class="font-semibold text-gray-900 dark:text-white line-clamp-1 group-hover:text-cyan-500 transition-colors"
              >
