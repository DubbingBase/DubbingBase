      ...
      >
        ...
        <div class="pb-4">
          ...
          <p class="text-gray-600 dark:text-gray-300 mt-2 text-lg">
            ...
            <span v-if="serie.number_of_seasons">
              &bull; {{ serie.number_of_seasons }} Saisons</span
            >
          </p>
        </div>
      </div>
        ...
        <div class="space-y-6">
          ...
          >
            ...
            >
              ...
              <NuxtLink v-if="isAdmin" :to="$localePath(`/show/${serie?.id || 'new'}/edit/${activeDubId || 'new'}`)" class="text-sm text-cyan-600 dark:text-cyan-400 hover:text-cyan-700 dark:hover:text-cyan-300 transition-colors flex items-center gap-2 font-medium">
