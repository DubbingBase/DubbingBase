<template>
  <div class="max-w-6xl mx-auto space-y-6">
    ...
    >
      ...
      >
        <span>{{
          parsedAdId ? "← Retour au spot" : "← Accueil"
        }}</span>
      </NuxtLink>
    </div>
    ...
    <form v-else @submit.prevent="saveAdProject" class="space-y-6">
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        >
          ...
          >
            <span>Informations Spot</span>
            <span class="text-xs text-emerald-400 font-normal">Campagne</span>
          </h4>
        ...
        >
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div class="space-y-1">
              <label
                class="text-xs font-semibold text-gray-400 uppercase tracking-wider"
                >Direction Artistique / Casting</label
              >
              <AsyncAutocomplete
        ...
        >
          <div>
            ...
            <p class="text-xs text-gray-400 mt-0.5">
              Associez les comédiens aux rôles ou voix off du spot.
            </p>
          </div>
          <button
            type="button"
